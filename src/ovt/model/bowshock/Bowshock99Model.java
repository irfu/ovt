...
public class Bowshock99Model {
    ...
    /** NOTE: The formula resembles eq. 3, Cairns et al., 1995 (above), which however
     * omits the proportionality constant. This should imply that
     * machNumber = (fast) Magnetosonic Mach number and swp = dynamic ram pressure (nP).
     * NOTE: The function might not behave as first intuitively expected since
     * changing the machNumber is NOT the same as changing the SW velocity,
     * since also swp is a function of SW velocity.
    ...
    /**
     * Returns the magnetic tangent line parameter x0, for the magnetic tangent
     * line in the form <code>x = (Bx/By)*r + x0</code>, where
     * <code>r = sqrt(y^2 + z^2)</code>
     */
    ...
    /**
     * y is in the frame where oz || component of imf which is perpendicular to
     * ox
     */
    ...
    /**
     * Returns the DIST and DIFF coordinate in the foreshock on the basis of
     * location gsm and solar wind params.
     */
    ...
    /**
     * Returns coordinates of the magnetic tangent toching the bowshock in
     * primed CS (where oz || component of imf which is perpendicular to ox)
     */
    ...
    /**
     * Returns the shortest distance from the point (gsm) to the bow shock. eMax
     ...
     * with the bow shock.
     *
     * Should return NaN if gsm is not connected to bow shock. Is not
     * checked!!!!
     */
    ...
    /**
     * Returns the angle (in radians) between the imf and a shock normal at the
     * point of intersection of imf vector with origin in gsm with the bow
     * shock.
     */
    ...
    /**
     * Reurns coordinate in the primed coordinate system: where oz || component
     * of imf which is perpendicular to ox
     */
